...
bool detectCycle(int nodes, vector<vector<int>>& adj) {
    ...
    int processedNodes = 0;  // Count of nodes processed
    ...
    // Step 4: If the number of processed nodes equals total nodes, no cycle
    return processedNodes != nodes;  // If processedNodes != nodes, a cycle exists
}
